...
insert into Chat (chat_name) values ('Default chat');
insert into Chat (chat_name) values ('Java Core');
insert into Chat (chat_name) values ('Java EE');
insert into Chat (chat_name) values ('Spring boot');
insert into Chat (chat_name) values ('Thymeleaf');
insert into Chat (chat_name) values ('Harry Potter');
insert into Chat (chat_name) values ('Games of Thrones');
insert into Chat (chat_name) values ('French Baroque');
insert into Chat (chat_name) values ('To be or not to be?');
insert into Chat (chat_name) values ('Happy New Year!!!');
insert into Chat (chat_name) values ('English language');
insert into Chat (chat_name) values ('Secret Forum');
...
alter table Chat_Message drop constraint message_fk_user;
alter table Chat_Message drop constraint message_fk_chat;
...
alter table Chat_Message add constraint message_fk_user FOREIGN KEY (sender_id) references users (user_Id);
alter table Chat_Message add constraint message_fk_chat FOREIGN KEY (chat_id) references Chat(id);
